...
### Analysis 2A1 - Chao-Shen Bias Correction

```{r}

entropy_formula <- 'entropy_chao_shen ~ modality + (1|word_index:task)'
...
### Analysis 2A2 - NSB Bias Correction

```{r}

entropy_formula <- 'entropy_nsb ~ modality + (1|word_index:task)'
...
### Analysis 2B1 - Chao-Shen Bias Correction

```{r}

entropy_formula <- 'entropy_chao_shen ~ modality * prominence_mean_words5 + (1|word_index:task)'
...
### Analysis 2B2 - NSB Bias Correction

```{r}

entropy_formula <- 'entropy_nsb ~ modality * prominence_mean_words5 + (1|word_index:task)'
